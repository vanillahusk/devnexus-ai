...
const loadColumnDetail = () => {
  return doGet<CommonResponse>(COLUMN_DETAIL_URL + `/${route.params['columnId']}/${route.params['sectionId']}`, {})
    .then((res) => {
...
const getArticleDetail = (response: ColumnArticlesResponseType & { commentPending?: boolean }) => {
