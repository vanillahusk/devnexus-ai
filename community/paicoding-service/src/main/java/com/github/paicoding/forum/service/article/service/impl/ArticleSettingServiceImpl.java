...
public class ArticleSettingServiceImpl implements ArticleSettingService {
    ...
    public void updateArticle(ArticlePostReq req) {
        ...
        Integer previousStatus = article.getStatus();
        ...
        ArticleKnowledgeOperationEnum knowledgeOperation;
        if (article.getStatus() == PushStatusEnum.ONLINE.getCode()) {
            knowledgeOperation = Objects.equals(previousStatus, PushStatusEnum.ONLINE.getCode())
                    ? ArticleKnowledgeOperationEnum.UPDATE : ArticleKnowledgeOperationEnum.ONLINE;
        } else {
            knowledgeOperation = ArticleKnowledgeOperationEnum.OFFLINE;
        }
        saveKnowledgeEvent(article.getId(), knowledgeOperation);
    ...
    public void deleteArticle(Long articleId) {
        ...
        if (dto != null && dto.getDeleted() != YesOrNoEnum.YES.getCode()) {
            ...
            saveKnowledgeEvent(articleId, ArticleKnowledgeOperationEnum.OFFLINE);
    ...
    private void saveKnowledgeEvent(Long articleId, ArticleKnowledgeOperationEnum operation) {
        long version = articleDao.nextKnowledgeVersion(articleId);
        mqOutboxService.saveArticleKnowledge(ArticleKnowledgeEvent.create(articleId, version, operation));
    }
}
