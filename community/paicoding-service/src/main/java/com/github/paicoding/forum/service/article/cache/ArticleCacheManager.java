...
public class ArticleCacheManager {
    ...
    public static final String ARTICLE_HOT_COMMENT_PREFIX = "article_hot_comment:";
        ...
        private final Cache<Long, ArticleDTO> localArticleInfoCache = Caffeine.newBuilder()
            .maximumSize(10_000)
    ...
    public ArticleDTO getArticleInfo(long articleId) {
        ArticleDTO local = localArticleInfoCache.getIfPresent(articleId);
        if (local != null) {
            return local;
        }
...
//        }
        ...
        if(value != null){
            ArticleDTO redisVal = OBJECT_MAPPER.convertValue(value, ArticleDTO.class);
            localArticleInfoCache.put(articleId, redisVal);
            return redisVal;
        }
        return null;
    }
    ...
    public void setArticleInfo(long articleId, ArticleDTO articleDTO){
        ...
        localArticleInfoCache.put(articleId, articleDTO);
//        try {
...
//        }
    ...
    public void delArticleInfo(long articleId) {
        ...
        localArticleInfoCache.invalidate(articleId);
    }
