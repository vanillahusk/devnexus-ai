...
public class UserFootDao extends ServiceImpl<UserFootMapper, UserFootDO> {
    ...
    public List<Long> listPraisedUserIds(Long articleId) {
        return baseMapper.listPraisedUserIds(articleId);
    }

    public List<Long> listRecentlyChangedArticleIds(Date since, int limit) {
        return baseMapper.listRecentlyChangedArticleIds(since, limit);
    }
}
