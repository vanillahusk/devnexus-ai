...
import com.github.paicoding.forum.auth.service.RuntimeConfigProbe;
...
public class AuthInternalRestController {
    ...
    private final RuntimeConfigProbe runtimeConfigProbe;
    ...
    @GetMapping(path = "config/probe")
    public ResVo<String> configProbe(HttpServletRequest request) {
        validate(request);
        return ResVo.ok(runtimeConfigProbe.value());
    }
