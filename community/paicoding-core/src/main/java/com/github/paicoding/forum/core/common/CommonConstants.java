...
public class CommonConstants {
    ...
    /**
     * RocketMQ 业务事件 Topic 与 Tag
     */
    public static final String ROCKETMQ_TOPIC_BUSINESS_EVENT = "paicoding-business-event";
    public static final String ROCKETMQ_TOPIC_ARTICLE_KNOWLEDGE = "paicoding-article-knowledge";
    public static final String ROCKETMQ_TAG_NOTIFY = "notify";
    public static final String ROCKETMQ_TAG_COMMENT_WRITE = "comment-write";
    public static final String ROCKETMQ_TAG_ARTICLE_KNOWLEDGE_V1 = "article-knowledge-v1";
