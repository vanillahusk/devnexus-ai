...
public class HttpRequestHelper {
    ...
    public static <R> R fetchContentWithoutProxy(String url, HttpMethod method, Map<String, String> params,
        ...
        RestTemplate restTemplate = buildRestTemplate(connectTimeoutMs, readTimeoutMs);
    ...
    public static <R> R fetchByRequestBody(String url, Map<String, Object> params, HttpHeaders headers,
        ...
        return fetchByRequestBody(url, params, headers, responseClass, false);
    }

    public static <R> R fetchByRequestBodyWithProxy(String url, Map<String, Object> params, HttpHeaders headers,
                                                    Class<R> responseClass) {
        return fetchByRequestBody(url, params, headers, responseClass, true);
    }

    public static <R> R fetchByRequestBodyWithoutProxy(String url, Map<String, Object> params, HttpHeaders headers,
                                                       Class<R> responseClass) {
        return fetchByRequestBody(url, params, headers, responseClass, false);
    }

    public static <R> R fetchByRequestBodyWithoutProxy(String url, Map<String, Object> params, HttpHeaders headers,
                                                       Class<R> responseClass, int connectTimeoutMs,
                                                       int readTimeoutMs) {
        return fetchByRequestBody(buildRestTemplate(connectTimeoutMs, readTimeoutMs), url, params, headers,
                responseClass, false);
    }
    ...
    private static <R> R fetchByRequestBody(String url, Map<String, Object> params, HttpHeaders headers,
                                            Class<R> responseClass, boolean useProxy) {
        String threadName = Thread.currentThread().getName();
        return fetchByRequestBody(restTemplateMap.getUnchecked(threadName), url, params, headers, responseClass,
                useProxy);
    }

    private static <R> R fetchByRequestBody(RestTemplate restTemplate, String url, Map<String, Object> params,
                                            HttpHeaders headers, Class<R> responseClass, boolean useProxy) {
        ResponseEntity<R> responseEntity;
        try {
            String host = "";
            try {
