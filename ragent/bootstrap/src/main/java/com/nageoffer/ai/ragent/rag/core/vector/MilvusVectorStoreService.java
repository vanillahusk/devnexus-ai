...
public class MilvusVectorStoreService implements VectorStoreService {
    ...
    public void indexDocumentChunks(String collectionName, String docId, List<VectorChunk> chunks) {
        ...
        InsertResp resp = mutateIndex(() -> milvusClient.insert(req));
    ...
    public void updateChunk(String collectionName, String docId, VectorChunk chunk) {
        ...
        UpsertResp resp = mutateIndex(() -> milvusClient.upsert(upsertReq));
    ...
    public void deleteDocumentVectors(String collectionName, String docId) {
        ...
        DeleteResp resp = mutateIndex(() -> milvusClient.delete(deleteReq));
    ...
    private <T> T mutateIndex(java.util.function.Supplier<T> mutation) {
