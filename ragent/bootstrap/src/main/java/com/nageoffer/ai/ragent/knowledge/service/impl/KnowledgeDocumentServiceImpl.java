...
import com.nageoffer.ai.ragent.core.chunk.ChunkIdentityNormalizer;
...
public class KnowledgeDocumentServiceImpl implements KnowledgeDocumentService {
    ...
    private void runChunkTask(KnowledgeDocumentDO documentDO) {
        ...
        try {
            ...
            ChunkIdentityNormalizer.normalize(documentDO.getId(), chunkResults);
    ...
    private String validateAndNormalizeChunkConfig(ChunkingMode mode, String chunkConfigJson) {
        ...
        if (config == null) {
            throw new ClientException("分块参数JSON必须是对象");
        }
        Map<String, Object> normalized = new HashMap<>(mode.getDefaultConfig());
