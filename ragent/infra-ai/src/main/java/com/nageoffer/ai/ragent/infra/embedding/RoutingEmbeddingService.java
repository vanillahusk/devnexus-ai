...
public class RoutingEmbeddingService implements EmbeddingService {
    ...
    private final EmbeddingCallGovernor governor;
    ...
    public RoutingEmbeddingService(
            ...
            EmbeddingCallGovernor governor,
    ...
    public List<Float> embed(String text) {
        return executor.executeWithFallback(
                ...
                (client, target) -> governor.execute(() -> client.embed(text, target))
        );
    }
    ...
    public List<Float> embed(String text, String modelId) {
        ...
        try {
            List<Float> vector = governor.execute(() -> client.embed(text, target));
    ...
    public List<List<Float>> embedBatch(List<String> texts) {
        return executor.executeWithFallback(
                ...
                selector.selectEmbeddingCandidates(),
                target -> clientsByProvider.get(target.candidate().getProvider()),
                (client, target) -> governor.execute(() -> client.embedBatch(texts, target))
        );
    }
    ...
    public List<List<Float>> embedBatch(List<String> texts, String modelId) {
        ...
        try {
            List<List<Float>> vectors = governor.execute(() -> client.embedBatch(texts, target));
            healthStore.markSuccess(target.id());
            return vectors;
        } catch (Exception e) {
            healthStore.markFailure(target.id());
