...
import com.nageoffer.ai.ragent.infra.model.ModelCallConcurrencyGovernor;
...
public class RoutingLLMService implements LLMService {
    ...
    private final ModelCallConcurrencyGovernor concurrencyGovernor;
    ...
    public RoutingLLMService(
            ...
            ModelCallConcurrencyGovernor concurrencyGovernor,
    ...
    @Trace(operationName = "rag.model.chat")
    public String chat(ChatRequest request) {
        return concurrencyGovernor.execute(ModelCapability.CHAT, () -> executor.executeWithFallback(
    ...
    @Trace(operationName = "rag.model.stream")
    public StreamCancellationHandle streamChat(ChatRequest request, StreamCallback callback) {
        ModelCallConcurrencyGovernor.Lease lease = concurrencyGovernor.acquire(ModelCapability.CHAT);
        StreamCallback guardedCallback = releasingCallback(callback, lease);
        try {
            StreamCancellationHandle handle = doStreamChat(request, guardedCallback);
            return () -> {
                try {
                    handle.cancel();
                } finally {
    ...
    private StreamCancellationHandle doStreamChat(ChatRequest request, StreamCallback callback) {
    ...
    private StreamCallback releasingCallback(StreamCallback callback,
                                             ModelCallConcurrencyGovernor.Lease lease) {
